 ...
 * @version ${version}
 */
public class AccountContact extends AbstractDirtyMarker implements ExtendDirtyBasicPNL.AccountContactPNL {
    private long id;
    ...
    public AccountContact setAddress2(String address2) {
        super.setUpdatedPropName(ADDRESS_2);
    ...
    public AccountContact setState(String state) {
        super.setUpdatedPropName(STATE);
        this.state = state;
    ...
    public AccountContact setCountry(String country) {
        super.setUpdatedPropName(COUNTRY);
    ...
    public AccountContact setZipCode(String zipCode) {
        super.setUpdatedPropName(ZIP_CODE);
